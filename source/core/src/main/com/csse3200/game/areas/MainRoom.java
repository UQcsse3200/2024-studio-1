...
public class MainRoom extends BaseRoom {
    ...
    List<List<String>> itemSpecifications = List.of(
            ...
            List.of("buff:energydrink:High", "item:shieldpotion", "ranged:shotgun", "melee:knife", "item:bandage"),
            List.of("item:medkit", "melee:knife", "buff:energydrink:Low", "ranged:shotgun", "item:shieldpotion")
    );
