...
public class PetFactory extends LoadedFactory {
    ...
    public Entity createRingFire() {
        ...
        Entity ringFire = createBaseNPC("ringFire", aiComponent, config, animator);
     ...
     * @param renderer    The renderer component for the NPC.
    ...
    private static Entity createBaseNPC(String name, Component aiComponent, NPCConfigs.NPCConfig config,
        ...
        if (renderer instanceof AnimationRenderComponent animator) {
